...
### Observação: Neste projeto é exposto um banco de dados público apenas para fins de testes. Nunca deixe o arquivo .env passar para a nuvem. Por favor não usar emails e fotos reais
